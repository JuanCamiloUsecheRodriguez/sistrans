...
import dao.DAOTablaabonamientos;
...
public class JMSCompraAbonamiento implements MessageListener, ExceptionListener
{
	 ...
	 */
	private Listaabonamientos respuesta;
	...
	public void cerrarRecursos() {
		for(Object ob : recursos){
			if(ob instanceof DAOTablaabonamientos)
				try {
					((DAOTablaabonamientos) ob).cerrarRecursos();
				} catch (Exception ex) {
					ex.printStackTrace();
				}
		}
	 ...
	 */
	public Listaabonamientos getabonamientosResponse() throws IncompleteReplyException, JMSException, NamingException, InterruptedException, NonReplyException {
